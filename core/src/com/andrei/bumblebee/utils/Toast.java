...
/**
 * Created by Vlad on 06.05.2015.
 * Simuleaza un TOAST asemeni celui din libraria nativa Android
 * preluat de la: http://www.badlogicgames.com/forum/viewtopic.php?f=11&t=484#p2959
 * modificat si adaptat
 */
public class Toast {
     ...
     *  @param fontScale scale of font toe be used
     ...
     * */
    public boolean makeText(String string, String _font, float fontScale, int prefered_color, int fade_mode, float x, float y, float time_to_spend) {
        ...
        switch (prefered_color) {
            ...
            case COLOR_PREF.BLUE: // BLUE prefered
                ...
                B[i] = 1.0f;
                break;
            case COLOR_PREF.BLACK: // BLACK prefered
                R[i] = 0.0f;
                G[i] = 0.0f;
                B[i] = 0.0f;
                break;
